...
This implies that in $\GTC$ the sequences made of only \quotationMarks{safe} reductions 
are finite. That is, this implies strong normalization for \quotationMarks{safe} reduction steps.
\\
