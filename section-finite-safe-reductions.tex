...
implements the addition. $f$ has a type 
$\N,\N\rightarrow\N$. $f$ is regular, and it is in $\GTC$ because
the unique infinite branch crosses the right-hand-side of a $\cond$
...
in a topology:
finiteness (which in our case is expressed by \emph{regulary}) is easily lost
under limit.
