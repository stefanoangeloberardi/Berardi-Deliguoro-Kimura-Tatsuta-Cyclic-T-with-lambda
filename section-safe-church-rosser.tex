...
We say that a reduction $\parallelReduces$ on $\CTlambda$ 
...
\begin{lemma}[Sufficient condition fo Unicity of normal form]
...
\begin{definition}[The maps $\phi_X$ and $\phi_{n,X}$]
