...
%To prove (\ref{lem:substitution-composition-1}), 
%all cases are trivial but when $t = \lambda y.t'$. 
%%If $x \not \in \FV(t) \supseteq \FV(t')$, then $t'[u/x] = t'$ by coinduction.
...
%\noindent
%\ref{lem:substitution-composition-1}) The only interesting
%
%\noindent
%\ref{lem:substitution-composition-2})
