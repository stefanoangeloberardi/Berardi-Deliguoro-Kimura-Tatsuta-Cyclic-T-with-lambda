...
\newcommand{\set}[1]{\{ #1 \}}
\newcommand{\BTree}{{\cal T}}
\newcommand{\rank}{\textit{rk}}
\newcommand{\nat}{\mathds{N}}
\newcommand{\SubTree}[2]{#1 \downarrow #2}
\newcommand{\LabelFun}{\phi}
\newcommand{\SigmaTerm}{\Sigma_{\textit{term}}}
%\newcommand{\Term}{\texttt{Term}}
\newcommand{\Term}{\Lambda^\infty}
