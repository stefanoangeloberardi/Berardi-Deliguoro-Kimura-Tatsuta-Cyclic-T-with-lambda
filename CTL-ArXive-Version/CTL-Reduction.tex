...
As for finitary $\lambda$-calculus, we identify $\alpha$-equivalent terms, namely terms that can be obtained by renaming of their bound variables, to avoid capture of free variables under substitution.
