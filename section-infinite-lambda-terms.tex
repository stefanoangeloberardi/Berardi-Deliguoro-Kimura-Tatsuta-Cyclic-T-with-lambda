...
for instance a proof cyclically switching the variables $x$ and $y$ in the context of a term:
 \[
  \infer[\weak]{
...
that all leftmost branches in any sub-proof are finite. 
%12:54 03/06/2024
...
then $\Pi$ is regular and we can compute one of such proofs. 
